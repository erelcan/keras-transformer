...
class TrainerABC(ABC):
    ...
    def train(self):
        ...
        model.compile(optimizer=create_optimizer(self._model_info["optimizer_info"]), loss=create_loss_function(self._model_info["loss_info"]), metrics=self._model_info.get("metrics", None))
        model.summary()
